...
class ReportTemplate(db.Model):
    ...
    # Relationships
    client = db.relationship('Client', backref='report_templates')
...
class GeneratedReport(db.Model):
    ...
    # Relationships
    client = db.relationship('Client', backref='generated_reports')
...
class ROITracking(db.Model):
    ...
    # Relationships
    client = db.relationship('Client', backref='roi_tracking')
...
class AnalyticsDashboard(db.Model):
    ...
    # Relationships
    client = db.relationship('Client', backref='analytics_dashboards')
...
class MetricAlert(db.Model):
    ...
    # Relationships
    client = db.relationship('Client', backref='metric_alerts')
