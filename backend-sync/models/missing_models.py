...
class Competitor(db.Model):
    ...
    # Relationships
    client = db.relationship('Client', back_populates='competitors')
    
    # Additional relationships to fix missing back_populates
    analyses = db.relationship('CompetitorAnalysis', back_populates='competitor')
    top_hashtags = db.relationship('CompetitorTopHashtag', back_populates='competitor')
    top_posts = db.relationship('CompetitorTopPost', back_populates='competitor')
    audience_demographics = db.relationship('CompetitorAudienceDemographic', back_populates='competitor')
    content = db.relationship('CompetitorContent', back_populates='competitor')
    ads = db.relationship('CompetitorAd', back_populates='competitor')
    strategies = db.relationship('CompetitorStrategy', back_populates='competitor')
    tracked_hashtags = db.relationship('CompetitorHashtag', back_populates='competitor')
...
class Campaign(db.Model):
    ...
    roi_tracking = db.relationship('ROITracking', back_populates='campaign')
...
class ScheduledPost(db.Model):
    ...
    # Relationships
    client = db.relationship('Client', back_populates='scheduled_posts')
    hashtag_performance = db.relationship('HashtagPerformance', back_populates='post')
