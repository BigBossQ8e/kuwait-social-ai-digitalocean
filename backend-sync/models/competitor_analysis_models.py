...
class CompetitorContent(db.Model):
    ...
    # Relationships
    competitor = db.relationship('Competitor', back_populates='content')
    sentiment_analysis = db.relationship('CompetitorSentiment', back_populates='content', lazy='dynamic')
...
class CompetitorSentiment(db.Model):
    ...
    # Relationships
    content = db.relationship('CompetitorContent', back_populates='sentiment_analysis')
...
class CompetitorAd(db.Model):
    ...
    # Relationships
    competitor = db.relationship('Competitor', back_populates='ads')
...
class CompetitorStrategy(db.Model):
    ...
    # Relationships
    competitor = db.relationship('Competitor', back_populates='strategies')
