...
class HashtagGroup(db.Model):
    ...
    # Relationships
    client = db.relationship('Client', back_populates='hashtag_groups')
    performance_records = db.relationship('HashtagPerformance', back_populates='group', lazy='dynamic')
...
class HashtagPerformance(db.Model):
    ...
    # Relationships
    client = db.relationship('Client', back_populates='hashtag_performance')
    post = db.relationship('ScheduledPost', back_populates='hashtag_performance')
    group = db.relationship('HashtagGroup', back_populates='performance_records')
...
class CompetitorHashtag(db.Model):
    ...
    # Relationships
    competitor = db.relationship('Competitor', back_populates='tracked_hashtags')
...
class HashtagRecommendation(db.Model):
    ...
    # Relationships
    client = db.relationship('Client', back_populates='hashtag_recommendations')
